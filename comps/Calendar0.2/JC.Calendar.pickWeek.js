(function($){
    ...
    Calendar.clone( WeekModel, WeekView );
    ...
    WeekView.prototype._buildBody =
        function( _dateo ){
            var _p = this
                ...
                , weeks = weekOfYear( _date.getFullYear(), JC.Calendar.pickWeek.dayOffset )
                , nextYearWeeks = weekOfYear( _date.getFullYear() + 1, JC.Calendar.pickWeek.dayOffset )
                , nextCount = 0
